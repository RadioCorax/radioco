        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                choices=[
                    ...
                    (b"el", "Greek"),
                    (b"en", "English"),
                    (b"en-au", "Australian English"),
                    (b"en-gb", "British English"),
                    (b"eo", "Esperanto"),
                    (b"es", "Spanish"),
                    (b"es-ar", "Argentinian Spanish"),
                    (b"es-mx", "Mexican Spanish"),
                    (b"es-ni", "Nicaraguan Spanish"),
                    (b"es-ve", "Venezuelan Spanish"),
                    (b"et", "Estonian"),
                    (b"eu", "Basque"),
                    (b"fa", "Persian"),
                    (b"fi", "Finnish"),
                    ...
                    (b"ur", "Urdu"),
                    (b"vi", "Vietnamese"),
                    (b"zh-cn", "Simplified Chinese"),
                    (b"zh-hans", "Simplified Chinese"),
                    (b"zh-hant", "Traditional Chinese"),
