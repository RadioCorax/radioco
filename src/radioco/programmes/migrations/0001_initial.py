            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        db_index=True, null=True, verbose_name="issue date", blank=True
                    ),
                ),
                (
                    "season",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Please DON'T change this value. It's used to build URL's.",
                        unique=True,
                        max_length=100,
                        verbose_name="name",
                    ),
                ...
                (
                    "end_date",
                    models.DateField(
                        help_text="This field can be null.",
                        null=True,
                ...
                (
                    "photo",
                    models.ImageField(
                        default=b"/static/radio/images/default-programme-photo.jpg",
                        upload_to=b"photos/",
                        verbose_name="photo",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        choices=[(b"ES", "Spanish"), (b"GA", "Galician")],
                    ),
                ),
                (
                    "current_season",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        choices=[
                            ...
                            (b"Games & Hobbies", "Games & Hobbies"),
                            (
                                b"Government & Organizations",
                                "Government & Organizations",
                            ),
                            (b"Health", "Health"),
                            (b"Kids & Family", "Kids & Family"),
                            (b"Music", "Music"),
                            (b"News & Politics", "News & Politics"),
                            (b"Religion & Spirituality", "Religion & Spirituality"),
                            (b"Science & Medicine", "Science & Medicine"),
                            (b"Society & Culture", "Society & Culture"),
                            (b"Sports & Recreation", "Sports & Recreation"),
